...
namespace X_O_X_Oyunu
{
    public partial class Selectgamer : Form
    {
        ...
        private void label1_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            random.Image = Image.FromFile(System.IO.Path.Combine(Application.StartupPath, "resim", "random.png"));
        }
        ...
        private void player1_MouseMove(object sender, MouseEventArgs e)
        {
            oyuncu1.ForeColor = Color.Maroon;
            oyuncu2.ForeColor = Color.Maroon;
            random.Image = Image.FromFile(System.IO.Path.Combine(Application.StartupPath, "resim", "random.ters.png"));
        }
